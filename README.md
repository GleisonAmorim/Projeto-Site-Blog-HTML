...
Projeto será remodelado completamente para versão uma versão sexy anime, vou incluir um sistema "Gacha" com o sorteio de cards para a blogueira em questão.
